          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div>
              ...
              <div className="relative">
                <User className="absolute left-3 to-1/2 transform -translate-y-1/2 text-gray-400 w-5 h-5"/>
                <input 
                type="text"
                name="fullName"
            ...
            <button
             ...
             <div className="text-center">
              <p className="text-gray-600">
                ...
                <a href="/login"
                className="text-blue-600 hover:text-blue-700 font-medium">Sign in here</a>
              </p>
             </div>
          </form>
        </motion.div>
