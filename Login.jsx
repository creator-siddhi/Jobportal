...
function Login() {
  ...
  function validatePassword(password){
    if(!password) return 'Please is required';
    return '';
  };
  ...
  function handleInputChange(e){
    ...
    //clear error whenuser starts typing
    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-gray-50 px-4">
         ...
         className="bg-white p-8 rounded-xl shadow-lg max-w-md w-full text-center">
          ...
          <div className="animate-spn w-6 h-6 border-2 border-blue-600 border-t-transparent rounded-full mx-auto"/>
           ...
           <div>
            ...
            <div className="relative">
              ...
              <input 
                ...
                onChange={handleInputChange}
                className={`w-full pl-10 pr-12 py3 rounded-lg border ${formState.errors.password ?'border-red-500':'border-gray-300'
                ...
                <button 
                  ...
                  className="absolute right-3 top-1/2 transform -translate-y-1/2 text-gray-400 hover:text-gray-600">
                    {formState.showPassword ?<EyeOff className="w-5 h-5"/> :<Eye clasw-5 h-5sNameclassName=""/>}
                </button>           
              </div>
